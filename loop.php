...
<TR>
	<TD width="160" style="padding:10px"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail(); ?></a></TD>
...
<TR>
	...
	<?php the_post_thumbnail(); ?>
				...
				<div class="order">
      				...
      				?>" alt="First Class Towing" Title="First Class Towing" width="130" height="35" /></a>
