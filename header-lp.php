...
<![endif]-->
<link rel="author" href="https://plus.google.com/u/0/109645465003840525812/posts"/> 
</head>

<body style="background: url('/bg.jpg') repeat-x scroll 0 0 #FFFFFF;">
<div id="wrapper">
 <div id="header">
	<div id="header_gradient">
		<div id="branding">
			...
			<div class="bullet1"><img alt="24/7 Towing" title="24/7 Towing"  src="<?php echo get_template_directory_uri() ?>/images/bullet.png" class="bullet_img"></div>
			<div class="bullet_text1"><?php echo $bullet1;?></div>
			<div class="bullet2"><img alt="Emergency Towing" title="Emergency Towing"  src="<?php echo get_template_directory_uri() ?>/images/bullet.png" class="bullet_img"></div>
